                ...
                <form action="<?= htmlspecialchars($indexPath) ?>" method="POST">
                    <div class="rxn-form-section">
                        ...
                        <div class="rxn-form-grid">
                            ...
                            <div class="rxn-form-span-6">
                                <label for="empresa_id" class="form-label">Empresa Asignada (Gesti贸n Local)</label>
                    ...
                    <div class="rxn-form-section">
                        <div class="rxn-form-section-title">Integraci贸n Tango</div>
                        <div class="rxn-form-grid">
                            <div class="rxn-form-span-12">
                                ...
                                <div class="form-text">Si se asocia, todas las cabeceras de pedidos o presupuestos emitidos por esta persona se generar谩n con los vendedores y talonarios definidos en este Perfil de Tango.</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="rxn-form-switches">
                            <div class="rxn-form-switch-card">
                                <div class="form-check form-switch m-0">
                                    ...
                                    <div class="form-text mb-0">Permite iniciar sesi贸n y operar normalmente.</div>
                                </div>
                            </div>
                            ...
                            <div class="rxn-form-switch-card">
                                <div class="form-check form-switch m-0">
                                    ...
                                    <div class="form-text mb-0">Habilita gesti髇 operativa ampliada dentro del tenant.</div>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="rxn-form-switch-card border-danger border-opacity-50" style="background-color: rgba(220,53,69,0.03);">
                                <div class="form-check form-switch m-0">
                                    ...
                                    <div class="form-text mb-0 text-danger opacity-75">Otorga el control global de sistema sobre todos los M骴ulos de Mantenimiento y Tenants.</div>
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
