...
<div class="table-responsive text-start">
    <table class="table table-hover table-sm align-middle view-table" id="rxnsync-table-art"
           ...
           data-ajax-container="articulos-content">
        <thead class="table-light">
            <tr>
                ...
                <th class="rxnsync-sortable rxn-filter-col" data-col="codigo" data-filter-field="codigo" style="padding-right:24px;">Código <span class="rxnsync-sort-icon"></span></th>
                <th>ID Tango</th>
                <th class="rxnsync-sortable rxn-filter-col" data-col="nombre" data-filter-field="nombre" style="padding-right:24px;">Nombre <span class="rxnsync-sort-icon"></span></th>
