...
<div class="d-flex gap-2 mb-3 align-items-center flex-wrap">
    <input type="text" id="rxnsync-search-cli" class="form-control form-control-sm border-info"
           placeholder="🔎 Buscar (F3 o /)..." style="max-width:260px;"
           data-search-input autocomplete="off">
    <select id="rxnsync-filter-estado-cli" class="form-select form-select-sm" style="width:170px;">
        <option value="">🔽 Todos los estados</option>
        <option value="vinculado">✅ Vinculados</option>
        <option value="pendiente">⏳ Pendientes</option>
        <option value="conflicto">❌ Conflicto</option>
    </select>
    <small class="text-muted ms-auto" id="rxnsync-cli-count"></small>
</div>
...
<div class="table-responsive text-start">
    <table class="table table-hover table-sm align-middle view-table" id="rxnsync-table-cli"
        ...
        <tbody id="rxnsync-tbody-cli">
            <?php if (empty($registros)): ?>
                <tr>
                    <td colspan="7" class="text-center text-muted py-4">
                        No hay información de auditoría para Clientes. Ejecute una Auditoría desde el tab.
                    </td>
                </tr>
            <?php else: ?>
