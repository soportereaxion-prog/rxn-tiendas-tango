...
<body class="rxn-page-shell rxn-auth-screen">
    ...
    <div class="card rxn-form-card rxn-auth-card shadow-sm p-4 p-lg-5 w-100">
        <div class="text-center mb-4">
            ...
            <h4 class="rxn-auth-title fw-bold">Recuperar Acceso</h4>
            <p class="text-secondary small rxn-auth-subtitle">Te enviaremos un enlace de recuperación seguro para volver a entrar sin complicaciones.</p>
        </div>
        ...
        <?php else: ?>
            <form action="/rxnTiendasIA/public/auth/forgot" method="POST">
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary w-100 fw-bold">Solicitar Enlace</button>
            </form>
        <?php endif; ?>
