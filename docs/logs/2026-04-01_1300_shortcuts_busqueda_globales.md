...
2. Se inyectó el script `<script src="/rxnTiendasIA/public/js/rxn-shortcuts.js"></script>` en 39 vistas (`index.php`, `crear.php`, `editar.php`, `form.php`) de todos los módulos. Anteriormente, los atajos de teclado no funcionaban porque el listener no estaba cargado en estas pantallas.
