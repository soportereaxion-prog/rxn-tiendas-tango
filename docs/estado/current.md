...
* **Presupuestos CRM v1 usable:** CRM suma una pantalla operativa de presupuestos con cabecera comercial, defaults por cliente, renglones acumulables, totales recalculados en backend y snapshots locales de cabecera/detalle para no romper historicos.
